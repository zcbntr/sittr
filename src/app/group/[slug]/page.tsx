...
import { getGroupWithMembersById, getPetsOfGroup } from "~/server/queries";
...
export default async function Page({ params }: { params: { slug: string } }) {
  ...
  const group = await getGroupWithMembersById(params.slug);
  ...
  if (group == null) {
    ...
    const petsOfGroup = await getPetsOfGroup(group.group.id);
